...
pipe_calculations = round(
    insulation_calculator(pipe_data), 2
...
pipe_cost_data.to_excel(
    writer, sheet_name="Pipe Data", index=False, startcol=1, startrow=len1
)
pipe_table_data.to_excel(
    writer, sheet_name="Pipe Data", index=False, startcol=1, startrow=len2
)
pipe_heat_savings.to_excel(
    writer, sheet_name="Pipe Data", index=False, startcol=1, startrow=len3
)
